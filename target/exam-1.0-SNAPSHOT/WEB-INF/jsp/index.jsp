...
<head>
    ...
    <title>Welcome!</title>
    <link rel="shortcut icon" href="./items/slack.ico" type="image/x-icon">
    <style>
        <%@include file='style/style.css'%>
        <%--<jsp:useBean id="user" beanName="user" class="by.epamtc.zhenekns.dev.entity.User" scope="application" type="by.epamtc.zhenekns.dev.entity.User"/>--%>
    </style>
</head>
<body>
<header class="header">

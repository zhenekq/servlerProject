...
<head>
    ...
    <title><fmt:message key="local.request-for-project"/></title>
...
<main class="main">
    <div class="main-wrapper wrapper">
        <h2 class="main-title" style="width: 310px"><fmt:message key="local.request-for-project"/></h2>
                    ...
                    <button type="button" class="order-box order-btn btn-reset">
                        <div class="order-title-box">
                            <h3 class="order-title">
                                <fmt:message key="local.project-request"/>
                            </h3>

                ...
                <div class="progect-form-content">
                    ...
                    <ul class="progect-list list-reset">
                        ...
                        <li class="progect-item">
                            ...
                            <input type="text" name="teamSize" value="${project.teamSize}" class="progect-input btn-reset" required>
                        </li>
                        <li class="progect-item">
                            <p class="progect-subtitle">Deadline: </p>
                            <input type="text" name="deadline" value="${project.deadline}" class="progect-input btn-reset" required>
                        </li>
                        <li class="progect-item">
                            <p class="progect-subtitle">Prise: </p>
                            <input type="text" name="cost"  value="${project.cost}" class="progect-input btn-reset" required>
                        </li>
                    </ul>

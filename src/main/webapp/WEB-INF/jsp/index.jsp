...
<body>
    <header class="header">
      ...
      <div class="right-header">
        <button class="login header-btn btn-reset"><a class="header-btn-link" href="?command=authorization_page">Login</a></button>
        <button class="sign-up header-btn btn-reset"><a class="header-btn-link" href="?command=registration_page">Sign-up</a></button>
      </div>
    </header>
    <main class="main">
      <div class="landing">
        <h1 class="landing-title">Brand new thinking</h1>
      </div>
      <div class="info">
        <p class="info-text">aaaaaaaaaaaaaaaaaaaaaaa
      ...
      <div class="navigation">
        <h2 class="nav-title">Title Adklkfd Fksdlkf</h2>
        <ul class="nav-list list-reset">
          <li class="nav-item"><p class="nav-text">text</p></li>
          <li class="nav-item-arrow">
            <svg class="nav-arrow" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
              y="0px" viewBox="0 0 490.667 490.667" style="enable-background:new 0 0 490.667 490.667;" xml:space="preserve">
